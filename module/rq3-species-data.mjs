  ...
  "human": {
    ...
    data: {
      ...
      system: {
        ...
        characteristicMods: { str: 0, con: 0, siz: 0, int: 0, pow: 0, dex: 0, app: 0, luck: 0 },
  ...
  "elf": {
    ...
    data: {
      ...
      system: {
        ...
        characteristicMods: { str: -1, con: 0, siz: -1, int: +1, pow: +2, dex: +1, app: +1, luck: +1 },
  ...
  "dwarf": {
    ...
    data: {
      ...
      system: {
        ...
        characteristicMods: { str: +1, con: +2, siz: -2, int: 0, pow: 0, dex: -1, app: -1, luck: 0 },
